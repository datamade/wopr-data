...
FROM '/project/evtimov/wopr/data/chicago-business-licenses_2013-10-31.csv'
WITH DELIMITER ','
CSV HEADER;
...
COPY SRC_chicago_business_licenses
FROM '/project/evtimov/wopr/data/chicago-business-licenses_2013-11-05.csv'
WITH DELIMITER ','
CSV HEADER;
